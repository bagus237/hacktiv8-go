...
func routes() {
	...
	http.HandleFunc("/contact", controller.Kontak)
	http.HandleFunc("/home", controller.Home)
	http.HandleFunc("/aboutLogin", controller.Aboutlogin)
	http.HandleFunc("/contactLogin", controller.Contact)
	http.HandleFunc("/artikel", controller.Article)
	http.HandleFunc("/register", controller.Register)
	http.HandleFunc("/artikelForm", controller.ArtikelForm)
	http.HandleFunc("/createArtikel", controller.CreateArtikel)
